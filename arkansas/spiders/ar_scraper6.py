...
class ArScraperSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.arkleg.state.ar.us/Acts/SearchByRange?start=100&startAct=1&endAct=188&ddBienniumSession=2021%2F2021R#SearchResults']
    ...
    def parse(self, response):
        try:
            ...
            with open(R'E:\arkansas_crawl\arkansas\output_6.csv',"w",newline=None, encoding='utf8') as myfile:
